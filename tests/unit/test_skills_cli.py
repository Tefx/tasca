...
def test_skills_list_exits_zero(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_skills_show_exits_zero(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_skills_show_unknown_skill_returns_nonzero(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_skills_install_requires_target(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_skills_install_copies_skill_to_target(
...
def test_skills_install_unknown_skill_returns_nonzero(
    tmp_path: pytest.TempPathFactory, capsys: pytest.CaptureFixture[str]
) -> None:
